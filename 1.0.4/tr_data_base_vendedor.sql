...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '75447b91-ec31-11ed-9be9-42010a400002:1-247463';
...
CREATE TABLE `vendedor` (
  ...
  `ven_latitud` double DEFAULT NULL,
  `ven_longitud` double DEFAULT NULL,
  PRIMARY KEY (`ven_id`),
...
-- Dump completed on 2023-05-21 15:42:41
